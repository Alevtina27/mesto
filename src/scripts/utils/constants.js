...
export const buttonEdit = document.querySelector(".profile__button_action_edit");
export const popupEdit = document.querySelector(".popup_type_edit");

export const nameElement = document.querySelector(".section-title");
//const nameFieldElement = document.querySelector(".popup__input_field_name");
export const infoElement = document.querySelector(".section-subtitle");
//const aboutFieldElement = document.querySelector(".popup__input_field_about");
...
export const formElementEdit = popupEdit.querySelector(".popup__input-container_edit");
export const formElementAdd = popupAddCard.querySelector(".popup__input-container_add");

/**const titleFieldElement = formElementAdd.querySelector(
  ".popup__input_field_title"
);
const linkFieldElement = formElementAdd.querySelector(
  ".popup__input_field_link"
);*/

/**const nameInput = document.querySelector("#input-name");
const infoInput = document.querySelector("#input-about");*/
...
//const popupImage = document.querySelector(".popup__figure");
